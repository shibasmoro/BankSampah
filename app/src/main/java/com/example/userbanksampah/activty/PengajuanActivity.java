...
public class PengajuanActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        model._minimal.observe(this, data -> {
            ...
            Log.d("dataminimal", "onCreate: "+data);
        });

        binding.verifikasi.setOnClickListener(view->{
            String nominal = binding.nama.getText().toString();
            model.addPengajuan("321",id_param,Integer.parseInt(nominal), Tanggal.getCurrentDate());
        });

        model.pesan.observe(PengajuanActivity.this,respon->{
           showToast(respon);
        });
    }
